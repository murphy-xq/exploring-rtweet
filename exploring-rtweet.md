...
#> 1 115185… 11008252… 2019-02-27 18:29:18 chrisalbon  Deri… Machi…               34 <NA>            
#> 2 115185… 11004606… 2019-02-26 18:20:41 chrisalbon  Why … Machi…               56 <NA>            
#> 3 115185… 11004598… 2019-02-26 18:17:23 chrisalbon  appl… Twitt…              121 <NA>            
#> 4 115185… 11002769… 2019-02-26 06:10:50 chrisalbon  @Mat… Twitt…               74 110011972331080…
#> 5 115185… 11002652… 2019-02-26 05:24:17 chrisalbon  Base… Twitt…              126 <NA>            
#> 6 115185… 11002641… 2019-02-26 05:19:46 chrisalbon  @Arm… Twitt…               75 110026331067340…
...
#> $ status_id               <chr> "1100825214542241793", "1100460658062053377", "1100459830236598280", "11002…
#> $ created_at              <dttm> 2019-02-27 18:29:18, 2019-02-26 18:20:41, 2019-02-26 18:17:23, 2019-02-26 …
#> $ screen_name             <chr> "chrisalbon", "chrisalbon", "chrisalbon", "chrisalbon", "chrisalbon", "chri…
#> $ text                    <chr> "Derivative https://t.co/eZ2bbpDzwV https://t.co/kweIzXBfjR", "Why Is It Ca…
#> $ source                  <chr> "Machine Learning Flashcards", "Machine Learning Flashcards", "Twitter for …
#> $ display_text_width      <dbl> 34, 56, 121, 74, 126, 75, 67, 4, 65, 3, 25, 48, 81, 194, 88, 118, 140, 35, …
#> $ reply_to_status_id      <chr> NA, NA, NA, "1100119723310804994", NA, "1100263310673403904", "110026216288…
#> $ reply_to_user_id        <chr> NA, NA, NA, "110474012", NA, "22803302", "14794913", "254873869", NA, "1503…
#> $ reply_to_screen_name    <chr> NA, NA, NA, "MattGallagher0", NA, "ArmsControlWonk", "AthertonKD", "LibyaLi…
#> $ is_quote                <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ is_retweet              <lgl> FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, …
#> $ favorite_count          <int> 17, 18, 0, 0, 125, 0, 4, 1, 0, 1, 1, 2, 2, 55, 10, 0, 0, 11, 31, 1, 16, 2, …
#> $ retweet_count           <int> 4, 1, 111, 0, 11, 0, 0, 0, 76, 0, 0, 0, 0, 4, 1, 167, 3, 3, 10, 0, 1, 0, 0,…
...
#> $ urls_url                <list> ["machinelearningflashcards.com", "machinelearningflashcards.com", "twitte…
#> $ urls_t.co               <list> ["https://t.co/eZ2bbpDzwV", "https://t.co/eZ2bbpDzwV", "https://t.co/soAVy…
#> $ urls_expanded_url       <list> ["https://machinelearningflashcards.com", "https://machinelearningflashcar…
#> $ media_url               <list> ["http://pbs.twimg.com/media/D0bqsvJU0AAO0Kr.png", "http://pbs.twimg.com/m…
#> $ media_t.co              <list> ["https://t.co/kweIzXBfjR", "https://t.co/uQcSZUCTvN", NA, NA, NA, NA, NA,…
#> $ media_expanded_url      <list> ["https://twitter.com/chrisalbon/status/1100825214542241793/photo/1", "htt…
#> $ media_type              <list> ["photo", "photo", NA, NA, NA, NA, NA, NA, "photo", NA, NA, NA, NA, NA, NA…
#> $ ext_media_url           <list> ["http://pbs.twimg.com/media/D0bqsvJU0AAO0Kr.png", "http://pbs.twimg.com/m…
#> $ ext_media_t.co          <list> ["https://t.co/kweIzXBfjR", "https://t.co/uQcSZUCTvN", NA, NA, NA, NA, NA,…
#> $ ext_media_expanded_url  <list> ["https://twitter.com/chrisalbon/status/1100825214542241793/photo/1", "htt…
#> $ ext_media_type          <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ mentions_user_id        <list> [NA, NA, "47436444", <"110474012", "291493735">, NA, <"22803302", "1479491…
#> $ mentions_screen_name    <list> [NA, NA, "jrmontag", <"MattGallagher0", "HeyTeachBK">, NA, <"ArmsControlWo…
#> $ lang                    <chr> "en", "en", "en", "en", "en", "en", "en", "fr", "en", "und", "en", "en", "e…
#> $ quoted_status_id        <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "1099319654563147777", …
#> $ quoted_text             <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "Bill Maher says red st…
#> $ quoted_created_at       <dttm> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 2019-02-23 14:46:44, N…
#> $ quoted_source           <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "SocialFlow", NA, NA, N…
#> $ quoted_favorite_count   <int> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 2566, NA, NA, NA, 1389,…
#> $ quoted_retweet_count    <int> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 770, NA, NA, NA, 349, N…
#> $ quoted_user_id          <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "2884771", NA, NA, NA, …
#> $ quoted_screen_name      <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "Newsweek", NA, NA, NA,…
#> $ quoted_name             <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "Newsweek", NA, NA, NA,…
#> $ quoted_followers_count  <int> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 3318914, NA, NA, NA, 13…
#> $ quoted_friends_count    <int> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 494, NA, NA, NA, 599, N…
#> $ quoted_statuses_count   <int> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 186480, NA, NA, NA, 110…
#> $ quoted_location         <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "New York, NY", NA, NA,…
#> $ quoted_description      <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "Stay relevant. News an…
#> $ quoted_verified         <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, TRUE, NA, NA, NA, TRUE,…
#> $ retweet_status_id       <chr> NA, NA, "1100432336905068544", NA, NA, NA, NA, NA, "1099900359324127232", N…
#> $ retweet_text            <chr> NA, NA, "applying for a data science job in 2010 vs. applying for a data sc…
#> $ retweet_created_at      <dttm> NA, NA, 2019-02-26 16:28:08, NA, NA, NA, NA, NA, 2019-02-25 05:14:15, NA, …
#> $ retweet_source          <chr> NA, NA, "Twitter Web App", NA, NA, NA, NA, NA, "Twitter for iPhone", NA, NA…
#> $ retweet_favorite_count  <int> NA, NA, 506, NA, NA, NA, NA, NA, 387, NA, NA, NA, NA, NA, NA, 903, 28, NA, …
#> $ retweet_retweet_count   <int> NA, NA, 111, NA, NA, NA, NA, NA, 76, NA, NA, NA, NA, NA, NA, 167, 3, NA, NA…
#> $ retweet_user_id         <chr> NA, NA, "47436444", NA, NA, NA, NA, NA, "1558406653", NA, NA, NA, NA, NA, N…
#> $ retweet_screen_name     <chr> NA, NA, "jrmontag", NA, NA, NA, NA, NA, "EpiEllie", NA, NA, NA, NA, NA, NA,…
#> $ retweet_name            <chr> NA, NA, "Josh Montague \U0001f4ca\U0001f389", NA, NA, NA, NA, NA, "Ellie Mu…
#> $ retweet_followers_count <int> NA, NA, 2946, NA, NA, NA, NA, NA, 4606, NA, NA, NA, NA, NA, NA, 1915, 6946,…
#> $ retweet_friends_count   <int> NA, NA, 2618, NA, NA, NA, NA, NA, 1170, NA, NA, NA, NA, NA, NA, 783, 150, N…
#> $ retweet_statuses_count  <int> NA, NA, 40328, NA, NA, NA, NA, NA, 12534, NA, NA, NA, NA, NA, NA, 9823, 214…
#> $ retweet_location        <chr> NA, NA, "Golden + Boulder (CO)", NA, NA, NA, NA, NA, "", NA, NA, NA, NA, NA…
#> $ retweet_description     <chr> NA, NA, "counts \U0001f425\U0001f4ac, drinks \u2615️, takes \U0001f4f7, lov…
#> $ retweet_verified        <lgl> NA, NA, FALSE, NA, NA, NA, NA, NA, FALSE, NA, NA, NA, NA, NA, NA, FALSE, FA…
#> $ place_url               <chr> NA, NA, NA, "https://api.twitter.com/1.1/geo/id/fbd6d2f5a4e4a15e.json", "ht…
#> $ place_name              <chr> NA, NA, NA, "California", "California", "California", "California", "Califo…
#> $ place_full_name         <chr> NA, NA, NA, "California, USA", "California, USA", "California, USA", "Calif…
#> $ place_type              <chr> NA, NA, NA, "admin", "admin", "admin", "admin", "admin", NA, "admin", "admi…
#> $ country                 <chr> NA, NA, NA, "United States", "United States", "United States", "United Stat…
#> $ country_code            <chr> NA, NA, NA, "US", "US", "US", "US", "US", NA, "US", "US", "US", "US", "US",…
...
#> $ bbox_coords             <list> [<NA, NA, NA, NA, NA, NA, NA, NA>, <NA, NA, NA, NA, NA, NA, NA, NA>, <NA, …
#> $ status_url              <chr> "https://twitter.com/chrisalbon/status/1100825214542241793", "https://twitt…
...
#> $ followers_count         <int> 31803, 31803, 31803, 31803, 31803, 31803, 31803, 31803, 31803, 31803, 31803…
...
#> $ statuses_count          <int> 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, 561, …
#> $ favourites_count        <int> 10314, 10314, 10314, 10314, 10314, 10314, 10314, 10314, 10314, 10314, 10314…
...
#>    <chr>       <chr>                             <chr>            <chr>                   <chr>               
#>  1 chrisalbon  Derivative https://t.co/eZ2bbpDz… machinelearning… http://pbs.twimg.com/m… derivative          
#>  2 chrisalbon  Why Is It Called A Cost Function… machinelearning… http://pbs.twimg.com/m… why-is-it-called-a-…
#>  3 chrisalbon  Meanshift Clustering By Analogy … machinelearning… http://pbs.twimg.com/m… meanshift-clusterin…
#>  4 chrisalbon  Interquartile Range https://t.co… machinelearning… http://pbs.twimg.com/m… interquartile-range 
#>  5 chrisalbon  Training And Test Error https://… machinelearning… http://pbs.twimg.com/m… training-and-test-e…
#>  6 chrisalbon  Saddle Point https://t.co/eZ2bbp… machinelearning… http://pbs.twimg.com/m… saddle-point        
#>  7 chrisalbon  Frobenius Norm https://t.co/eZ2b… machinelearning… http://pbs.twimg.com/m… frobenius-norm      
#>  8 chrisalbon  Hidden Layer https://t.co/eZ2bbp… machinelearning… http://pbs.twimg.com/m… hidden-layer        
#>  9 chrisalbon  Matthews Correlation Coefficient… machinelearning… http://pbs.twimg.com/m… matthews-correlatio…
#> 10 chrisalbon  Occams Razor https://t.co/eZ2bbp… machinelearning… http://pbs.twimg.com/m… occams-razor        
#> # … with 14 more rows
```
...
pull_tweets <- function(url,                 # 30-day search stem
  ...
  while (!is.null(nxt_tkn) && i <= max_req) {
    print(str_c("loop", i))
